              ...
              return (
                <tr>
                  ...
                  <td>
                    <a
                      href={
                        "https://etherscan.io/address/" + orderItem.customer
                      }
                      rel="noopener noreferrer"
                      target="_blank"
                    >
                      {" "}
                      {orderItem.customer.substring(0, 6)}...
                      {orderItem.customer.substring(38, 42)}
                    </a>
                  </td>
                  <td>{orderItem.name}</td>
                  <td>{orderItem.quantity}</td>
                  <td>
                    {this.props.web3.utils.fromWei(orderItem.totalPrice)}
                    &nbsp;ETH
                  </td>
                  <td>
                    {orderItem.hostelOrCanteen === 0 ? "Hostel" : "Canteen"}
                  </td>
                  ...
                  <td>
                    <Button
                      ...
                      disabled={
                        ...
                        this.props.account !== this.props.canteenOwner
                      }
                  ...
                  <td>
                    <ButtonGroup className="me-2" aria-label="First group">
                      <Button
                        disabled={
                          orderItem.customer !== this.props.account ||
                          orderItem.rating !== 0 ||
                      ...
                      <Button
                        ...
                        variant={
                          orderItem.rating === 3 ? "warning" : "secondary"
                        }
                      >
                        3
                      </Button>
                      <Button
                        ...
                        variant={
                          orderItem.rating === 4 ? "success" : "secondary"
                        }
                      >
                        4
                      </Button>
                      <Button
                        ...
                        variant={
                          orderItem.rating === 5 ? "success" : "secondary"
                        }
                      >
                        5
                      </Button>
